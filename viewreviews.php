...
<div class="social_comments"><div class="fb-comments" data-href="https://www.killjoy.co.za/viewer.php?claw=<?php echo json_encode($property_id) ?>" data-width="80%" data-numposts="5"></div></div>
</div>
 <?php }  ?>
