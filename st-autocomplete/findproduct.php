<?php require_once('../Connections/stomer.php'); ?>
 <?php
	...
	$sql="SELECT DISTINCT herb_name AS Product, 'tbl_herbs' AS Source, page_url AS page FROM tbl_herbs WHERE herb_name LIKE '%$my_data%' UNION SELECT DISTINCT vegtable_name AS Product, 'tbl_vegetables' AS Source, page_url as page FROM tbl_vegetables WHERE vegtable_name LIKE '%$my_data%'  ORDER BY Product ASC";
