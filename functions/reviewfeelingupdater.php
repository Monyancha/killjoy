...
</style></head><body>Dear ". $name ."<br><br>You have changed your mood setting for a property review.</strong><br><br>Your changes to the review of <strong>".$row_get_address['str_number']."&nbsp;".$row_get_address['street_name']."&nbsp;".$row_get_address['city']."</strong> has been recorded.<br><br>Thank you for sharing your experiences. This conversion greatly impacts the way future tenants view a potential property.<br><br>The rental property review change was submitted by: <a href='mailto:$email'>$email</a> on $date at $time<br><br>If this was not you, please let us know by sending an email to: <a href='mailto:friends@killjoy.co.za'>Killjoy</a><br><br>Thank
