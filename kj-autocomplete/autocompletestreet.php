<?php require_once('../Connections/killjoy.php'); ?>
 <?php
	...
	$sql="SELECT DISTINCT street_name AS Street, tbl_address.sessionid As id, city as Town FROM tbl_address LEFT JOIN tbl_address_comments ON tbl_address_comments.sessionid = tbl_address.sessionid LEFT JOIN tbl_approved ON tbl_approved.sessionid = tbl_address.sessionid WHERE tbl_address.street_name LIKE '%$my_data%' AND tbl_approved.is_approved='1' ORDER BY Street ASC";
