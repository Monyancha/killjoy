<?php require_once('../Connections/rentaguide.php'); ?>
 <?php
	...
	$sql="SELECT DISTINCT IFNULL(agency_name, 'New Agency') AS Agency, tbl_estateagencies.sessionid AS estatesession, tbl_estatelogos.sessionid as logosession, citytown as Town, suburb AS Suburb, tbl_estatelogos.image_url As Logo FROM tbl_estateagencies LEFT JOIN tbl_estatelogos ON tbl_estatelogos.sessionid = tbl_estateagencies.sessionid WHERE agency_name LIKE '%$my_data%' OR citytown LIKE '%$my_data%' ORDER BY Agency ASC";
