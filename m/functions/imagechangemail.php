...
$query_rs_showproperty = sprintf("SELECT tbl_address_comments.id as commentId, tbl_address_comments.sessionid as sessionId, tbl_address_comments.rating_date AS rating_date, tbl_address.str_number as str_number, tbl_address.street_name as street_name, tbl_address.city as city, tbl_address.postal_code as postal_code, tbl_propertyimages.image_url as propertyImage, social_users.g_name as socialUsername, social_users.g_email AS socialUsermail FROM tbl_address_comments LEFT JOIN tbl_address ON tbl_address.sessionid = tbl_address_comments.sessionid LEFT JOIN social_users ON social_users.g_email = tbl_address_comments.social_user LEFT JOIN tbl_propertyimages ON tbl_propertyimages.sessionid = tbl_address.sessionid WHERE tbl_address_comments.id = %s", GetSQLValueString($colname_rs_showproperty, "int"));
