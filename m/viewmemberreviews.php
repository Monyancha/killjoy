...
<div id="formcontainer">
 ...
 <div id="impresseionsummary" class="impression-summary"><div class="comment-impression"><?php echo $row_rs_show_review['socialComments'] ?><?php if($row_rs_show_review['socialComments'] < 2) { ?> Person <?php } ?><?php if($row_rs_show_review['socialComments'] > 1) { ?> People <?php } ?>commented</div></div>
