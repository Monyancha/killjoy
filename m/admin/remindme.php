...
<div class="maincontainer" id="maincontainer">
 <form id="register" class="form" name="register" target="_parent" method="POST" action="remindme.php">
  ...
  <div class="formfields" id="formfields"><span id="sprytextfield1">
    ...
    <div class="formfields" id="formfields"></div>
  <div class="accpetfield" id="accpetfield"> <div class="accepttext">Please verify your details above then click Continue. We will send you instructions on how to recover your password.</div> 
