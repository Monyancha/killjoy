...
</style></head><body>Dear ". $name ."<br><br>Your password was successfully changed.<br><br>If you have not already signed in again, please <a href='https://www.killjoy.co.za/admin/index.php'>Login to killjoy.co.za</a> to make the new changes take affect.<br><br>The password reset request was sent from: <a href='mailto:$email'>$email</a> on $date at $time<br><br>If this was not you, please let us know by sending an email to: <a href='mailto:friends@killjoy.co.za'>Killjoy</a><br><br><br><br>Thank
...
<div class="maincontainer" id="maincontainer">
 <form id="register" class="form" name="register" method="POST" target="_parent" action="changepassword.php">
  ...
  <div class="accpetfield" id="accpetfield"><div class="accepttext"></div></div>
	...
	$("#changepassword").dialog({ closeText: '' });
     elem.dialog({
     resizable: false,
	 autoOpen: false,
     ...
     elem.dialog('open');
	$('#changepassword').bind('dialogclose', function(event) {
