...
<div class="confirm" id="confirm">Dear <?php echo $name ?>, Thank you for registering. An email has been sent to <a href="mailto:<?php echo $email ?>"><?php echo $email ?></a>. Please follow the instructions in th e link to activate your account.<br><br> Thank you, the <a href="https://www.killjoy.co.za">The killjoy Team</a></div>
 </div>
