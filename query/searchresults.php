...
$query_rs_search_results = "SELECT tbl_address.sessionid, tbl_address.str_number as strNumber, tbl_address.street_name AS Street, tbl_address.city as city, (SELECT COUNT(tbl_address_comments.sessionid) FROM tbl_address_comments WHERE tbl_address_comments.sessionid = tbl_address.sessionid AND tbl_approved.is_approved=1) AS reviewCount, IFNULL(tbl_propertyimages.image_url,'https://www.killjoy.co.za/images/icons/house-outline-bg.png') AS propertyImage, IFNULL(tbl_approved.is_approved,'0') as Status, ROUND(AVG(tbl_address_rating.rating_value),1) AS avgRating, (SELECT COUNT(tbl_address_rating.address_comment_id) FROM tbl_address_comments WHERE tbl_address_rating.address_comment_id = tbl_address_comments.id) as ratingCount FROM `euqjdems_killjoy`.`tbl_address` LEFT JOIN tbl_address_comments ON tbl_address_comments.sessionid = tbl_address.sessionid LEFT JOIN tbl_approved ON tbl_approved.address_comment_id = tbl_address_comments.id LEFT JOIN tbl_propertyimages ON tbl_propertyimages.sessionid = tbl_address.sessionid LEFT JOIN tbl_address_rating ON tbl_address_rating.address_comment_id = tbl_address_comments.id WHERE (CONVERT(`str_number` USING utf8) LIKE '%15%' OR CONVERT(`street_name` USING utf8) LIKE '%15%' OR CONVERT(`city` USING utf8) LIKE '%15%' OR CONVERT(`province` USING utf8) LIKE '%15%' OR CONVERT(`postal_code` USING utf8) LIKE '%15%' OR CONVERT(`Country` USING utf8) LIKE '%15%')  AND  (CONVERT(`str_number` USING utf8) LIKE '%Berg%' OR CONVERT(`street_name` USING utf8) LIKE '%Berg%' OR CONVERT(`city` USING utf8) LIKE '%Berg%' OR CONVERT(`province` USING utf8) LIKE '%Berg%' OR CONVERT(`postal_code` USING utf8) LIKE '%Berg%' OR CONVERT(`Country` USING utf8) LIKE '%Berg%')  AND  (CONVERT(`str_number` USING utf8) LIKE '%En%' OR CONVERT(`street_name` USING utf8) LIKE '%En%' OR CONVERT(`city` USING utf8) LIKE '%En%' OR CONVERT(`province` USING utf8) LIKE '%En%' OR CONVERT(`postal_code` USING utf8) LIKE '%En%' OR CONVERT(`Country` USING utf8) LIKE '%En%')  AND  (CONVERT(`str_number` USING utf8) LIKE '%Dal%' OR CONVERT(`street_name` USING utf8) LIKE '%Dal%' OR CONVERT(`city` USING utf8) LIKE '%Dal%' OR CONVERT(`province` USING utf8) LIKE '%Dal%' OR CONVERT(`postal_code` USING utf8) LIKE '%Dal%')  AND  (CONVERT(`str_number` USING utf8) LIKE '%Wellington%' OR CONVERT(`street_name` USING utf8) LIKE '%Wellington%' OR CONVERT(`city` USING utf8) LIKE '%Wellington%' OR CONVERT(`province` USING utf8) LIKE '%Wellington%' OR CONVERT(`postal_code` USING utf8) LIKE '%Wellington%' OR CONVERT(`Country` USING utf8) LIKE '%Wellington%')";
...
mysql_select_db($database_killjoy, $killjoy);
$query_rs_search_engine = "SELECT tbl_address.sessionid, tbl_address.str_number as strNumber, tbl_address.street_name AS Street, tbl_address.city as city, (SELECT COUNT(tbl_address_comments.sessionid) FROM tbl_address_comments WHERE tbl_address_comments.sessionid = tbl_address.sessionid AND tbl_approved.is_approved=1) AS reviewCount, IFNULL(tbl_propertyimages.image_url,'https://www.killjoy.co.za/images/icons/house-outline-bg.png') AS propertyImage FROM `euqjdems_killjoy`.`tbl_address` LEFT JOIN tbl_address_comments ON tbl_address_comments.sessionid = tbl_address.sessionid LEFT JOIN tbl_approved ON tbl_approved.address_comment_id = tbl_address_comments.id LEFT JOIN tbl_propertyimages ON tbl_propertyimages.sessionid = tbl_address.sessionid WHERE (CONVERT(`str_number` USING utf8) LIKE '%15%' OR CONVERT(`street_name` USING utf8) LIKE '%15%' OR CONVERT(`city` USING utf8) LIKE '%15%' OR CONVERT(`province` USING utf8) LIKE '%15%' OR CONVERT(`postal_code` USING utf8) LIKE '%15%' OR CONVERT(`Country` USING utf8) LIKE '%15%')  AND  (CONVERT(`str_number` USING utf8) LIKE '%Berg%' OR CONVERT(`street_name` USING utf8) LIKE '%Berg%' OR CONVERT(`city` USING utf8) LIKE '%Berg%' OR CONVERT(`province` USING utf8) LIKE '%Berg%' OR CONVERT(`postal_code` USING utf8) LIKE '%Berg%' OR CONVERT(`Country` USING utf8) LIKE '%Berg%')  AND  (CONVERT(`str_number` USING utf8) LIKE '%En%' OR CONVERT(`street_name` USING utf8) LIKE '%En%' OR CONVERT(`city` USING utf8) LIKE '%En%' OR CONVERT(`province` USING utf8) LIKE '%En%' OR CONVERT(`postal_code` USING utf8) LIKE '%En%' OR CONVERT(`Country` USING utf8) LIKE '%En%')  AND  (CONVERT(`str_number` USING utf8) LIKE '%Dal%' OR CONVERT(`street_name` USING utf8) LIKE '%Dal%' OR CONVERT(`city` USING utf8) LIKE '%Dal%' OR CONVERT(`province` USING utf8) LIKE '%Dal%' OR CONVERT(`postal_code` USING utf8) LIKE '%Dal%')  AND  (CONVERT(`str_number` USING utf8) LIKE '%Wellington%' OR CONVERT(`street_name` USING utf8) LIKE '%Wellington%' OR CONVERT(`city` USING utf8) LIKE '%Wellington%' OR CONVERT(`province` USING utf8) LIKE '%Wellington%' OR CONVERT(`postal_code` USING utf8) LIKE '%Wellington%' OR CONVERT(`Country` USING utf8) LIKE '%Wellington%')";
