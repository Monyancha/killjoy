...
$smith = urlencode($smith);
	...
	$reviews = "review";	
			...
			echo ($marker."<a href='https://query.killjoy.co.za/viewer.php?tarsus=".$captcha."&claw=".$row['id'] ."&alula=".$smith."' title='There $are $title $reviews for this property'>".$row['strNumber']." ".$row['Street']). ", ". $row['Town']. " " . $new_id."</a>". "\n ";	
		}
	}
?>