...
</style></head><body>Dear ". $name ."<br><br>Your password was successfully changed.<br><br>If you have not signed in, please <a href='https://www.killjoy.co.za/admin/index.php'>Login to killjoy.co.za</a> to make the new changes take affect.<br><br>The password reset request was sent from: <a href='mailto:$email'>$email</a> on $date at $time<br><br>If this was not you, please let us know by sending an email to: <a href='mailto:friends@killjoy.co.za'>Killjoy</a><br><br>Thank
...
<?php
((mysqli_free_result($rs_get_name) || (is_object($rs_get_name) && (get_class($rs_get_name) == "mysqli_result"))) ? true : false);
?>
