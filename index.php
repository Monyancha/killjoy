...
$query_rs_kj_recall = sprintf("SELECT g_name, g_email, g_active FROM social_users WHERE g_email = %s AND g_active = 1", GetSQLValueString($colname_rs_kj_recall, "text"));
...
mysql_free_result($rs_kj_recall);
?>
